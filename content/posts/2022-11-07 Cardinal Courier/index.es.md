...
{{< imagehalftoc class="imageright" src="images/bake-sale-es.png" alt="Folleto de venta de pasteles" >}}
...
{{< imagehalftoc class="imageright" src="images/reflections-art-show-es.png" alt="Folleto de Reflections Art Show" >}}
...
{{< imagehalftoc class="imageright" src="images/cardinal-coding-club-es.png" alt="Folleto del Cardenal Coding Club" >}}
...
{{< imagehalftoc src="images/amazonsmile-es.png" alt="Folleto de AmazonSmile" >}}
{{< imagehalftoc src="images/harris-teeter-es.png" alt="folleto de Harris Teeter" >}}
...
{{< imagehalftoc class="imageright" src="images/chipotle-thank-you.jpg" alt="Folleto de agradecimiento de Chipotle" >}}
...
{{< imagehalftoc  class="imagecenter" src="images/IMG_5930.jpg" alt="Superhéroe Abingdon Cardinal" >}}