...
{{< imgresize o=360x class="imageright" src="files/meeting-flyer-es.png" alt="Folleto de la reunión general de miembros" >}}
...
{{< imgresize o=360x class="imageright" src="files/IMG_4137.jpg" alt="muro del Mes de la Herencia Hispana" >}}
...
{{< imgresize o=360x class="imageright" src="files/trunk-or-treat-es.png" alt="Trunk or Treat flyer" >}}
...
{{< imgresize o=360x class="imageright" src="files/outdoor-lab-es.png" alt="Folleto de laboratorio al aire libre" >}}
...
- **Los alumnos de 3.er grado de Abingdon** visitarán el laboratorio al aire libre para excursiones el **21 y 22 de febrero de 2023.**
...
{{< imgresize o=360x class="imageright" src="files/r---show-your-voice_facebook-cropped.png" alt="Folleto de reflexiones" >}}
...
{{< imgresize o=360x class="imageright" src="files/walk-bike-roll.png" alt="Folleto Walk Bike & Roll" >}}
...
{{< imgresize o=360x class="imageright" src="files/IMG_4361.jpg" alt="Fotos de Lifetouch para distribución" >}}
...
{{< imgresize o=360x class="imageright" src="files/IMG_4379.jpg" alt="Ropa para colocar en Lost & Found" >}}
...
{{< imgresize o=360x class="imageright" src="files/snack-pantry-es.png" alt="Folleto de Snack Pantry" >}}
...
{{< figresize o=736x src="files/IMG_0981.jpg" alt="El cardenal de Abingdon en el patio de recreo de Abingdon" >}}