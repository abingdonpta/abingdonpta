...
{{< imagehalftoc class="imageright" src="images/meeting-flyer-es.png" alt="Folleto de la reunión general de miembros" >}}
...
{{< imagehalftoc class="imageright" src="images/IMG_4137.jpg" alt="muro del Mes de la Herencia Hispana" >}}
...
{{< imagehalftoc class="imageright" src="images/trunk-or-treat-es.png" alt="Trunk or Treat flyer" >}}
...
{{< imagehalftoc class="imageright" src="images/outdoor-lab-es.png" alt="Folleto de laboratorio al aire libre" >}}
...
{{< imagehalftoc class="imageright" src="images/r---show-your-voice_facebook-cropped.png" alt="Folleto de reflexiones" >}}
...
{{< imagehalftoc class="imageright" src="images/walk-bike-roll.png" alt="Folleto Walk Bike & Roll" >}}
...
{{< imagehalftoc class="imageright" src="images/IMG_4361.jpg" alt="Fotos de Lifetouch para distribución" >}}
...
{{< imagehalftoc class="imageright" src="images/IMG_4379.jpg" alt="Ropa para colocar en Lost & Found" >}}
...
{{< imagehalftoc class="imageright" src="images/snack-pantry-es.png" alt="Folleto de Snack Pantry" >}}
...
{{< imagetoc src="images/IMG_0981.jpg" alt="El cardenal de Abingdon en el patio de recreo de Abingdon" >}}