...
{{< imagehalftoc class="imageright" src="images/skate-night-es.png" alt="Folleto de la noche de skate" >}}
...
{{< imagehalftoc class="imageright" src="images/snack-pantry-es.png" alt="Folleto de la despensa de bocadillos" >}}
...
{{< imagehalftoc class="imageright" src="images/lunar-new-year-es.png" alt="Folleto del Año Nuevo Lunar" >}}
...
{{< imagehalftoc class="imageright" src="images/chinese-club-es.png" alt="Folleto del Año Nuevo Lunar" >}}
...
{{< imagehalftoc class="imageright" src="images/winter-assessments.png" alt="Folleto de fechas de evaluaciones de invierno" >}}
...
{{< imagehalftoc class="imageright" src="images/clothing-drive-es.png" alt="Folleto de la campaña de ropa" >}}
...
{{< imagehalftoc class="imageright" src="images/mabels-labels.png" alt="folleto de etiquetas Mabels" >}}
...
{{< imagehalftoc class="imageright" src="images/septa.png" alt="Folleto de la feria de actividades de SEPTA" >}}
...
{{< imagehalftoc class="imagecenter" src="images/cardinal-garden.jpg" alt="Abingdon Cardinal en el jardín de la escuela" >}}