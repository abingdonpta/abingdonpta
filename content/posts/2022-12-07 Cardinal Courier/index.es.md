...
{{< imagehalftoc class="imageright" src="files/winter-enrichment-es.png" alt="Folleto de enriquecimiento de invierno" >}}
...
{{< imagehalftoc class="imagecenter" src="files/spirit-week.png" alt="Folleto de la Semana del Espíritu" >}}

## ☕ Charla de café de la Asociación entre la escuela y la familia del Título I de Abingdon

{{< imagehalftoc class="imageright" src="files/title-i-es.png" alt="Título I Volantes" >}}
...
{{< imagehalftoc class="imageright" src="files/gift-card-drive.png" alt="Folleto de la colecta de tarjetas de regalo" >}}
...
{{< imagehalftoc class="imageright" src="files/mabels-labels.png" alt="Folleto de etiquetas de Mabels" >}}
...
{{< imagehalftoc  class="imagecenter" src="files/IMG_3668.jpg" alt="Lectura del cardenal de Abingdon" >}}