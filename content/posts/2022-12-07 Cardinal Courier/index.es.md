...
{{< imagehalftoc class="halfright" src="images/winter-enrichment-es.png" alt="Folleto de enriquecimiento de invierno" >}}
...
{{< imagehalftoc class="halfcenter" src="images/spirit-week.png" alt="Folleto de la Semana del Espíritu" >}}

## ☕ Charla de café de la Asociación entre la escuela y la familia del Título I de Abingdon

{{< imagehalftoc class="halfright" src="images/title-i-es.png" alt="Título I Volantes" >}}
...
{{< imagehalftoc class="halfright" src="images/gift-card-drive.png" alt="Folleto de la colecta de tarjetas de regalo" >}}
...
{{< imagehalftoc class="halfright" src="images/mabels-labels.png" alt="Folleto de etiquetas de Mabels" >}}
